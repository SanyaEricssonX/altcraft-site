...
Пользователь имеет право подать жалобу на другого игрока, если тот нарушает правила сервера и этому есть доказательства.

Жалобу обязаны рассмотреть администраторы.
